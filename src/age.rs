...
pub enum StellarPopulation {
    ...
    E2(f64),
    /// Immensely old hypothetical population-III — too rare to come up with a random roll.
    // Age value not present as by nature they're almost exactly as old as the universe itself, if they exist.
    III
